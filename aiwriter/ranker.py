...
def rank_essay(essay: str, criteria: list[str]):
    ...
    response = cast(Any, llm.chat.completions.create(
...
def cli():
    ...
    from env import SCORES_FILE, CRITERIA_FILE, ESSAY_FILE
